...
# Moved |media| from negativeRe to positiveRe
# Our custom classes are in front
REGEXES = {
    'unlikelyCandidatesRe': re.compile('android-banner|pageinfo|hidden|cnn_strylceclbtn|cnn_stryshrwdgtbtm|slashpop|feedburner|combx|comment|community|disqus|extra|foot|header|menu|remark|rss|shoutbox|sidebar|sponsor|ad-break|agegate|pagination|pager|popup|tweet|twitter', re.I),
    'okMaybeItsACandidateRe': re.compile('and|article|body|column|main|shadow', re.I),
    'positiveRe': re.compile('article|body|content|entry|hentry|main|media|page|pagination|post|text|blog|story', re.I),
    'negativeRe': re.compile('combx|comment|comments|com-|contact|foot|footer|footnote|masthead|meta|outbrain|promo|related|scroll|shoutbox|sidebar|sponsor|shopping|tags|tool|widget', re.I),
